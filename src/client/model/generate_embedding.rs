...
use crate::{
    abi::model::generate_embedding::{GenerateEmbeddingRequest, GenerateEmbeddingResponse},
    client::{Action, ollama::OllamaClient},
    error::OllamaError,
};

impl Action<GenerateEmbeddingRequest, GenerateEmbeddingResponse> {
...
impl IntoFuture for Action<GenerateEmbeddingRequest, GenerateEmbeddingResponse> {
    type Output = Result<GenerateEmbeddingResponse, OllamaError>;
